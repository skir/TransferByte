...
static void SCB_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SCB_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[SCB_1_RX_SDA_MOSI_PIN_INDEX] = SCB_1_HSIOM_I2C_SEL;
            hsiomSel[SCB_1_TX_SCL_MISO_PIN_INDEX] = SCB_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SCB_1_RX_SDA_MOSI_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
            hsiomSel[SCB_1_TX_SCL_MISO_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
            hsiomSel[SCB_1_CTS_SCLK_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
            ...
            if (SCB_1_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SCB_1_RTS_SS0_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SCB_1_TX_SCL_MISO_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                pinsDm  [SCB_1_TX_SCL_MISO_PIN_INDEX] = SCB_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SCB_1_RX_SDA_MOSI_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                    pinsDm  [SCB_1_RX_SDA_MOSI_PIN_INDEX] = SCB_1_PIN_DM_DIG_HIZ;
                }
                ...
                if (SCB_1_UART_MODE_STD == subMode)
                {
                    if (0u != (SCB_1_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SCB_1_CTS_SCLK_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                        pinsDm  [SCB_1_CTS_SCLK_PIN_INDEX] = SCB_1_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (SCB_1_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SCB_1_RTS_SS0_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                        pinsDm  [SCB_1_RTS_SS0_PIN_INDEX] = SCB_1_PIN_DM_STRONG;
