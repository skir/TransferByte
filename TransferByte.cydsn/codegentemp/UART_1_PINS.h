...
#if (UART_1_RX_WAKE_SDA_MOSI_PIN)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (UART_1_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
