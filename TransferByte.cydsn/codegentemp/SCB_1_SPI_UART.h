...
****************************************/
    ...
    #define SCB_1_CHECK_SPI_WAKE_ENABLE  (0u != SCB_1_scbEnableWake)
    ...
    /* Internal RX and TX buffer: for SPI or UART */
        ...
        /* Get FIFO size */
            ...
            #define SCB_1_SPI_UART_FIFO_SIZE    (SCB_1_FIFO_SIZE)
        #else
            #define SCB_1_SPI_UART_FIFO_SIZE \
                                           SCB_1_GET_FIFO_SIZE(SCB_1_SPI_BYTE_MODE_ENABLE)
        ...
        #else
            #define SCB_1_SPI_UART_FIFO_SIZE \
                                           SCB_1_GET_FIFO_SIZE(SCB_1_UART_BYTE_MODE_ENABLE)
        #endif /* (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
