...
static void UART_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void UART_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[UART_1_RX_SDA_MOSI_PIN_INDEX] = UART_1_HSIOM_I2C_SEL;
            hsiomSel[UART_1_TX_SCL_MISO_PIN_INDEX] = UART_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[UART_1_RX_SDA_MOSI_PIN_INDEX] = UART_1_HSIOM_SPI_SEL;
            hsiomSel[UART_1_TX_SCL_MISO_PIN_INDEX] = UART_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[UART_1_TX_SCL_MISO_PIN_INDEX] = UART_1_HSIOM_UART_SEL;
                pinsDm  [UART_1_TX_SCL_MISO_PIN_INDEX] = UART_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[UART_1_RX_SDA_MOSI_PIN_INDEX] = UART_1_HSIOM_UART_SEL;
                    pinsDm  [UART_1_RX_SDA_MOSI_PIN_INDEX] = UART_1_PIN_DM_DIG_HIZ;
                }
